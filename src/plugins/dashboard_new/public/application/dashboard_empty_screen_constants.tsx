...
export const emptyDashboardTitle: string = i18n.translate('dashboardNew.emptyDashboardTitle', {
  defaultMessage: 'This dashboard is empty.',
});
export const emptyDashboardAdditionalPrivilege = i18n.translate(
  'dashboardNew.emptyDashboardAdditionalPrivilege',
  {
    defaultMessage: 'You need additional privileges to edit this dashboard.',
  }
);
/** VIEW MODE CONSTANTS **/
export const fillDashboardTitle: string = i18n.translate('dashboardNew.fillDashboardTitle', {
...
export const howToStartWorkingOnNewDashboardDescription1: string = i18n.translate(
  'dashboardNew.howToStartWorkingOnNewDashboardDescription1',
  {
    defaultMessage: 'Click',
  }
);
export const howToStartWorkingOnNewDashboardDescription2: string = i18n.translate(
  'dashboardNew.howToStartWorkingOnNewDashboardDescription2',
  {
...
export const howToStartWorkingOnNewDashboardEditLinkText: string = i18n.translate(
  'dashboardNew.howToStartWorkingOnNewDashboardEditLinkText',
  {
    defaultMessage: 'Edit',
  }
);
export const howToStartWorkingOnNewDashboardEditLinkAriaLabel: string = i18n.translate(
  'dashboardNew.howToStartWorkingOnNewDashboardEditLinkAriaLabel',
  {
