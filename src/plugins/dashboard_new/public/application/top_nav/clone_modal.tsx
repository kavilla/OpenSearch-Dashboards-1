  ...
  renderDuplicateTitleCallout = () => {
    ...
    return (
      <Fragment>
        ...
        <EuiCallOut
          size="s"
          title={i18n.translate('dashboardNew.topNav.cloneModal.dashboardExistsTitle', {
        ...
        >
          <p>
            <FormattedMessage
              id="dashboardNew.topNav.cloneModal.dashboardExistsDescription"
              defaultMessage="Click {confirmClone} to clone the dashboard with the duplicate title."
              values={{
                confirmClone: (
                  <strong>
                    <FormattedMessage
                      id="dashboardNew.topNav.cloneModal.confirmCloneDescription"
    ...
    return (
      ...
      >
        <EuiModalHeader>
          <EuiModalHeaderTitle>
            <FormattedMessage
              id="dashboardNew.topNav.cloneModal.cloneDashboardModalHeaderTitle"
        ...
        <EuiModalBody>
          <EuiText>
            <p>
              <FormattedMessage
                id="dashboardNew.topNav.cloneModal.enterNewNameForDashboardDescription"
          ...
          <EuiFieldText
            autoFocus
            aria-label={i18n.translate('dashboardNew.cloneModal.cloneDashboardTitleAriaLabel', {
        ...
        <EuiModalFooter>
          <EuiButtonEmpty data-test-subj="cloneCancelButton" onClick={this.props.onClose}>
            <FormattedMessage
              id="dashboardNew.topNav.cloneModal.cancelButtonLabel"
          ...
          >
            <FormattedMessage
              id="dashboardNew.topNav.cloneModal.confirmButtonLabel"
              defaultMessage="Confirm Clone"
            />
          </EuiButton>
        </EuiModalFooter>
