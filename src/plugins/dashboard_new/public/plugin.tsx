...
export class DashboardPlugin
  ...
  public setup(
    ...
    const {
      ...
      storageKey: `lastUrl:${core.http.basePath.get()}:dashboardNew`,
    ...
    urlForwarding.forwardApp(
      ...
      DashboardConstants.DASHBOARDS_ID,
      (path) => {
        const [, id, tail] = /dashboardNew\/?(.*?)($|\?.*)/.exec(path) || [];
        if (!id && !tail) {
    ...
    if (home) {
      home.featureCatalogue.register({
        ...
        title: i18n.translate('dashboardNew.featureCatalogue.dashboardTitle', {
          defaultMessage: 'DashboardNew',
        }),
        subtitle: i18n.translate('dashboardNew.featureCatalogue.dashboardSubtitle', {
          defaultMessage: 'Analyze data in dashboards.',
        }),
        description: i18n.translate('dashboardNew.featureCatalogue.dashboardDescription', {
          defaultMessage: 'Display and share a collection of visualizations and saved searches.',
        }),
        icon: 'dashboardApp',
        path: `/app/dashboardsNew#${DashboardConstants.LANDING_PAGE_PATH}`,
