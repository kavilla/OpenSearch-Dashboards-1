...
function getFullScreenConfig(action: NavAction) {
  return {
    id: 'full-screen',
    label: i18n.translate('dashboardNew.topNave.fullScreenButtonAriaLabel', {
      defaultMessage: 'full screen',
    }),
    description: i18n.translate('dashboardNew.topNave.fullScreenConfigDescription', {
...
function getEditConfig(action: NavAction) {
  return {
    ...
    id: 'edit',
    iconType: 'pencil',
    label: i18n.translate('dashboardNew.topNave.editButtonAriaLabel', {
      defaultMessage: 'edit',
    }),
    description: i18n.translate('dashboardNew.topNave.editConfigDescription', {
...
function getSaveConfig(action: NavAction) {
  return {
    id: 'save',
    label: i18n.translate('dashboardNew.topNave.saveButtonAriaLabel', {
      defaultMessage: 'save',
    }),
    description: i18n.translate('dashboardNew.topNave.saveConfigDescription', {
...
function getViewConfig(action: NavAction) {
  return {
    id: 'cancel',
    label: i18n.translate('dashboardNew.topNave.cancelButtonAriaLabel', {
      defaultMessage: 'cancel',
    }),
    description: i18n.translate('dashboardNew.topNave.viewConfigDescription', {
...
function getCloneConfig(action: NavAction) {
  return {
    id: 'clone',
    label: i18n.translate('dashboardNew.topNave.cloneButtonAriaLabel', {
      defaultMessage: 'clone',
    }),
    description: i18n.translate('dashboardNew.topNave.cloneConfigDescription', {
...
function getAddConfig(action: NavAction) {
  return {
    id: 'add',
    label: i18n.translate('dashboardNew.topNave.addButtonAriaLabel', {
      defaultMessage: 'add',
    }),
    description: i18n.translate('dashboardNew.topNave.addConfigDescription', {
...
function getCreateNewConfig(action: NavAction) {
  return {
    ...
    id: 'addNew',
    label: i18n.translate('dashboardNew.topNave.addNewButtonAriaLabel', {
      defaultMessage: 'Create new',
    }),
    description: i18n.translate('dashboardNew.topNave.addNewConfigDescription', {
...
function getShareConfig(action: NavAction | undefined) {
  return {
    id: 'share',
    label: i18n.translate('dashboardNew.topNave.shareButtonAriaLabel', {
      defaultMessage: 'share',
    }),
    description: i18n.translate('dashboardNew.topNave.shareConfigDescription', {
...
function getOptionsConfig(action: NavAction) {
  return {
    id: 'options',
    label: i18n.translate('dashboardNew.topNave.optionsButtonAriaLabel', {
      defaultMessage: 'options',
    }),
    description: i18n.translate('dashboardNew.topNave.optionsConfigDescription', {
      defaultMessage: 'Options',
    }),
