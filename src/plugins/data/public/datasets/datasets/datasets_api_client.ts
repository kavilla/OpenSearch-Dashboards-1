...
import { BaseGetFieldsOptions, IDatasetsApiClient } from '../../../common/datasets/types';
...
export class DatasetsApiClient implements IDatasetsApiClient {
  ...
  getFieldsForTimePattern(options: BaseGetFieldsOptions = {}) {
  ...
  getFieldsForWildcard(options: BaseGetFieldsOptions = {}) {
