...
export const getNavActions = (
      ...
      const EmbedUrlParamExtension = ({
        ...
        const checkboxes = [
          {
            ...
            label: i18n.translate('dashboardNew.embedUrlParamExtension.topMenu', {
              defaultMessage: 'Top menu',
            }),
          },
          {
            id: UrlParams.SHOW_QUERY_INPUT,
            label: i18n.translate('dashboardNew.embedUrlParamExtension.query', {
              defaultMessage: 'Query',
            }),
          },
          {
            id: UrlParams.SHOW_TIME_FILTER,
            label: i18n.translate('dashboardNew.embedUrlParamExtension.timeFilter', {
              defaultMessage: 'Time filter',
            }),
          },
          {
            id: UrlParams.SHOW_FILTER_BAR,
            label: i18n.translate('dashboardNew.embedUrlParamExtension.filterBar', {
        ...
        return (
          <EuiCheckboxGroup
            ...
            legend={{
              children: i18n.translate('dashboardNew.embedUrlParamExtension.include', {
  ...
  function onChangeViewMode(newMode: ViewMode) {
    ...
    overlays
      .openConfirm(
        i18n.translate('dashboardNew.changeViewModeConfirmModal.discardChangesDescription', {
          defaultMessage: `Once you discard your changes, there's no getting them back.`,
        }),
        {
          confirmButtonText: i18n.translate(
            'dashboardNew.changeViewModeConfirmModal.confirmButtonLabel',
            { defaultMessage: 'Discard changes' }
          ),
          cancelButtonText: i18n.translate(
            'dashboardNew.changeViewModeConfirmModal.cancelButtonLabel',
            { defaultMessage: 'Continue editing' }
          ),
          defaultFocusedButton: EUI_MODAL_CANCEL_BUTTON,
          title: i18n.translate('dashboardNew.changeViewModeConfirmModal.discardChangesTitle', {
    ...
    try {
      ...
      if (id) {
        notifications.toasts.addSuccess({
          title: i18n.translate('dashboardNew.dashboardWasSavedSuccessMessage', {
      ...
      notifications.toasts.addDanger({
        title: i18n.translate('dashboardNew.dashboardWasNotSavedDangerMessage', {
