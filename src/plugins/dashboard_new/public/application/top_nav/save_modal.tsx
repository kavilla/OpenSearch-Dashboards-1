    ...
    return (
      <Fragment>
        <EuiFormRow
          label={
            <FormattedMessage
              id="dashboardNew.topNav.saveModal.descriptionFormRowLabel"
        ...
        <EuiFormRow
          helpText={
            <FormattedMessage
              id="dashboardNew.topNav.saveModal.storeTimeWithDashboardFormRowHelpText"
        ...
        >
          <EuiSwitch
            ...
            label={
              <FormattedMessage
                id="dashboardNew.topNav.saveModal.storeTimeWithDashboardFormRowLabel"
