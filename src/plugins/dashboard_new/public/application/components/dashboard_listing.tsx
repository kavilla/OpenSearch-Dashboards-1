...
export const DashboardListing = () => {
  ...
  useMount(() => {
    chrome.setBreadcrumbs([
      {
        text: i18n.translate('dashboardNew.dashboardBreadcrumbsTitle', {
    ...
    chrome.docTitle.change(
      i18n.translate('dashboardNew.dashboardPageTitle', { defaultMessage: 'Dashboards' })
    );
  });
  ...
  return (
    <TableListView
      ...
      entityName={i18n.translate('dashboardNew.listing.table.entityName', {
        defaultMessage: 'dashboard',
      })}
      entityNamePlural={i18n.translate('dashboardNew.listing.table.entityNamePlural', {
        defaultMessage: 'dashboards',
      })}
      tableListTitle={i18n.translate('dashboardNew.listing.dashboardsTitle', {
        defaultMessage: 'Dashboards',
      })}
