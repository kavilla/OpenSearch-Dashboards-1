...
export class DashboardPlugin implements Plugin<DashboardPluginSetup, DashboardPluginStart> {
  ...
  public setup(core: CoreSetup) {
    this.logger.debug('dashboardNew: Setup');

    // TODO: dashboardNew - registerType
    // TODO: WE KNOW `Stack Management > Saved Objects` will not work correctly
  ...
  public start(core: CoreStart) {
    this.logger.debug('dashboardNew: Started');
    return {};
  }
